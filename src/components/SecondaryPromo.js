...
const SecondaryPromo = () => {
    ...
    return (
        <Box w='100%' px={screenSize === 'mobile' ? 5 : 10} display='flex' alignItems='center' justifyContent='center' overflow='hidden'>
            <Box w='1580px'>
                <Box position='relative'>
                    <Box h={containerHeight} display='flex' alignItems='flex-end'>
                        <Box position='absolute' bottom={containerBottom} top={containerTop} h={promoHeight} w='100%' display='flex' alignItems='center' justifyContent='center' bgGradient='linear(to-br, springgreen, mediumseagreen)' px={screenSize !== 'extraLarge' && 20} _hover={{ boxShadow:'0px 4px 30px rgba(5, 248, 125, 0.6)' }} transition='box-shadow 0.3s ease' borderRadius='3xl'>
                                ...
                                <Box w='50%' display='flex' alignItems='center' justifyContent='center'>
                                    <Box>
                                        ...
                                        <Box display='flex' mt={8}>
                                            <Box
                                                bg='white' h='42px' w='120px' borderRadius='full' color='mediumseagreen' _hover={{ bg: '#1a202c', color: 'white' }} transition='background-color 0.3s ease' as='button'>
                            ...
                            >
                                <Box display='flex' alignItems='center' justifyContent='center'>
                                    <Box position='absolute' bottom={500} >
                                        <Image src='products/smartwatch.png' w={imageResize} />
                                    </Box>
                                </Box>
                                <VStack>
